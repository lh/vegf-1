---
title: "Enhanced Discontinuation Model Simulation Report"
...
This report presents the results of an Enhanced Discontinuation Model simulation for Age-related Macular Degeneration (AMD) treatment. The simulation was conducted using a `r sim_data$simulation_type` approach with a population of `r sim_data$population_size` patients over a `r sim_data$duration_years`-year period.
...
disc_rates <- data.frame(
  ...
  Type = rep(c("Planned", "Premature", "Administrative", "Time-based"), 3),
  Rate = c(
