"""
A simple standalone example showing DES adapter functionality.

This script demonstrates the enhanced DES adapter with a custom visualization
that doesn't rely on the Streamlit components.
"""
...
def main():
    ...
    # Save the figure
    output_file = "simple_des_visualization.png"
